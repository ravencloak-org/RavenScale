...
| Frontend | Erlich | Branding/UI-forward persona — admin dashboard (weakest inference) |
| QA | Honey | Compat-harness gate (no strong persona signal) |
...
**Bench / unassigned:** Big Head, Bumble, Fizz, Russ Hanneman — available as reviewers or extra capacity. Gilfoyle is proposed on 8 issues (all infra + all security); rebalancing toward the bench is worth considering. Russ Hanneman is a natural product-side voice on the Phase-3 gate (#20).
